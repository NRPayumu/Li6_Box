...
private:
	...
	G4int     fCaptureEmitGamma ; //count emitting gamma at ncapture
	G4int     fCaptureEmitEplus ;
...
inline void EventAction::AddGam(){
	fCaptureEmitGamma  += 1;
}
inline void EventAction::AddEpl(){
	fCaptureEmitEplus  += 1;
}
inline void EventAction::AddEmi(){
	fCaptureEmitEminus += 1;
}
inline void EventAction::AddTri(){
	fCaptureEmitTriton += 1;
}
